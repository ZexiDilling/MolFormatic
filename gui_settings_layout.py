    ...
    def settings_bio_final_report(self):
        ...
        well_col = sg.Frame("Well report", [[
            sg.Column([
                ...
                [sg.HorizontalSeparator()],
                [sg.Text("Hit Threshold", relief="groove", size=15), sg.T("Minimum", size=7), sg.T("Maximum", size=8)],
                [sg.T("TH-1 bound", size=10),
                 sg.Checkbox("use", key="-PORA_TH_1_THRESHOLD_USE-", size=self.checkbox_size,
                             default=self.final_setup["pora_threshold"]["th_1"]["use"]),
                 sg.InputText(key="-PORA_TH_1_MIN_HIT_THRESHOLD-", size=8,
                              default_text=self.final_setup["pora_threshold"]["th_1"]["min"]),
                 sg.InputText(key="-PORA_TH_1_MAX_HIT_THRESHOLD-", size=8,
                              default_text=self.final_setup["pora_threshold"]["th_1"]["max"])],
                [sg.T("TH-2 bound", size=10),
                 sg.Checkbox("use", key="-PORA_TH_2_THRESHOLD_USE-", size=self.checkbox_size,
                             default=self.final_setup["pora_threshold"]["th_2"]["use"]),
                 sg.InputText(key="-PORA_TH_2_MIN_HIT_THRESHOLD-", size=8,
                              default_text=self.final_setup["pora_threshold"]["th_2"]["min"]),
                 sg.InputText(key="-PORA_TH_2_MAX_HIT_THRESHOLD-", size=8,
                              default_text=self.final_setup["pora_threshold"]["th_2"]["max"])],
                [sg.T("TH-3 bound", size=10),
                 sg.Checkbox("use", key="-PORA_TH_3_THRESHOLD_USE-", size=self.checkbox_size,
                             default=self.final_setup["pora_threshold"]["th_3"]["use"]),
                 sg.InputText(key="-PORA_TH_3_MIN_HIT_THRESHOLD-", size=8,
                              default_text=self.final_setup["pora_threshold"]["th_3"]["min"]),
                 sg.InputText(key="-PORA_TH_3_MAX_HIT_THRESHOLD-", size=8,
                              default_text=self.final_setup["pora_threshold"]["th_3"]["max"])],
                [sg.T("TH-4 bound", size=10),
                 sg.Checkbox("use", key="-PORA_TH_4_THRESHOLD_USE-", size=self.checkbox_size,
                             default=self.final_setup["pora_threshold"]["th_4"]["use"]),
                 sg.InputText(key="-PORA_TH_4_MIN_HIT_THRESHOLD-", size=8,
                              default_text=self.final_setup["pora_threshold"]["th_4"]["min"]),
                 sg.InputText(key="-PORA_TH_4_MAX_HIT_THRESHOLD-", size=8,
                              default_text=self.final_setup["pora_threshold"]["th_4"]["max"])],
                [sg.T("TH-5 bound", size=10),
                 sg.Checkbox("use", key="-PORA_TH_5_THRESHOLD_USE-", size=self.checkbox_size,
                             default=self.final_setup["pora_threshold"]["th_5"]["use"]),
                 sg.InputText(key="-PORA_TH_5_MIN_HIT_THRESHOLD-", size=8,
                              default_text=self.final_setup["pora_threshold"]["th_5"]["min"]),
                 sg.InputText(key="-PORA_TH_5_MAX_HIT_THRESHOLD-", size=8,
                              default_text=self.final_setup["pora_threshold"]["th_5"]["max"])],
                [sg.T("TH-6 bound", size=10),
                 sg.Checkbox("use", key="-PORA_TH_6_THRESHOLD_USE-", size=self.checkbox_size,
                             default=self.final_setup["pora_threshold"]["th_6"]["use"]),
                 sg.InputText(key="-PORA_TH_6_MIN_HIT_THRESHOLD-", size=8,
                              default_text=self.final_setup["pora_threshold"]["th_6"]["min"]),
                 sg.InputText(key="-PORA_TH_6_MAX_HIT_THRESHOLD-", size=8,
                              default_text=self.final_setup["pora_threshold"]["th_6"]["max"])],
                [sg.T("TH-7 bound", size=10),
                 sg.Checkbox("use", key="-PORA_TH_7_THRESHOLD_USE-", size=self.checkbox_size,
                             default=self.final_setup["pora_threshold"]["th_7"]["use"]),
                 sg.InputText(key="-PORA_TH_7_MIN_HIT_THRESHOLD-", size=8,
                              default_text=self.final_setup["pora_threshold"]["th_7"]["min"]),
                 sg.InputText(key="-PORA_TH_7_MAX_HIT_THRESHOLD-", size=8,
                              default_text=self.final_setup["pora_threshold"]["th_7"]["max"])],
                [sg.T("TH-8 bound", size=10),
                 sg.Checkbox("use", key="-PORA_TH_8_THRESHOLD_USE-", size=self.checkbox_size,
                             default=self.final_setup["pora_threshold"]["th_8"]["use"]),
                 sg.InputText(key="-PORA_TH_8_MIN_HIT_THRESHOLD-", size=8,
                              default_text=self.final_setup["pora_threshold"]["th_8"]["min"]),
                 sg.InputText(key="-PORA_TH_8_MAX_HIT_THRESHOLD-", size=8,
                              default_text=self.final_setup["pora_threshold"]["th_8"]["max"])],
                [sg.T("TH-9 bound", size=10),
                 sg.Checkbox("use", key="-PORA_TH_9_THRESHOLD_USE-", size=self.checkbox_size,
                             default=self.final_setup["pora_threshold"]["th_9"]["use"]),
                 sg.InputText(key="-PORA_TH_9_MIN_HIT_THRESHOLD-", size=8,
                              default_text=self.final_setup["pora_threshold"]["th_9"]["min"]),
                 sg.InputText(key="-PORA_TH_9_MAX_HIT_THRESHOLD-", size=8,
                              default_text=self.final_setup["pora_threshold"]["th_9"]["max"])],
                [sg.T("TH-10 bound", size=10),
                 sg.Checkbox("use", key="-PORA_TH_10_THRESHOLD_USE-", size=self.checkbox_size,
                             default=self.final_setup["pora_threshold"]["th_10"]["use"]),
                 sg.InputText(key="-PORA_TH_10_MIN_HIT_THRESHOLD-", size=8,
                              default_text=self.final_setup["pora_threshold"]["th_10"]["min"]),
                 sg.InputText(key="-PORA_TH_10_MAX_HIT_THRESHOLD-", size=8,
                              default_text=self.final_setup["pora_threshold"]["th_10"]["max"])]
            ])
        ]])
    ...
    def settings_bio_plate_report(self):
        ...
        col_analysis_sheet = sg.Frame("Setup for analysis sheet", [[
            sg.Column([
                ...
                [sg.Checkbox("pstdev", key="-BIO_PLATE_REPORT_ORG_PST_DEV-", enable_events=True,
                             default=self.plate_setup["plate_calc_dict"]["original"]["pstdev"]),
                 sg.Checkbox("pvariance", key="-BIO_PLATE_CAL_ORG_P_VARIANCE-",
                             default=self.plate_setup["plate_calc_dict"]["original"]["pvariance"],
                             disabled=analysis_sheet_org),
                 sg.Checkbox("variance", key="-BIO_PLATE_CAL_ORG_VARIANCE-",
                             default=self.plate_setup["plate_calc_dict"]["original"]["variance"],
                             disabled=analysis_sheet_org),
                 sg.Checkbox("st_dev_", key="-BIO_PLATE_REPORT_ORG_ST_DEV_PERCENTAGE-", enable_events=True,
                             default=self.plate_setup["plate_calc_dict"]["original"]["st_dev_%"])],
                ...
                [sg.Checkbox("Normalised", key="-BIO_PLATE_REPORT_NORM_CALC-", enable_events=True,
                 ...
                 sg.Checkbox("stdev", key="-BIO_PLATE_CAL_NORM_STDEV-",
                             ...
                             disabled=analysis_sheet_norm)],
                [sg.Checkbox("pstdev", key="-BIO_PLATE_REPORT_NORM_PST_DEV-", enable_events=True,
                             default=self.plate_setup["plate_calc_dict"]["original"]["pstdev"]),
                 sg.Checkbox("pvariance", key="-BIO_PLATE_CAL_NORM_P_VARIANCE-",
                             default=self.plate_setup["plate_calc_dict"]["original"]["pvariance"],
                             disabled=analysis_sheet_org),
                 sg.Checkbox("variance", key="-BIO_PLATE_CAL_NORM_VARIANCE-",
                             default=self.plate_setup["plate_calc_dict"]["original"]["variance"],
                             disabled=analysis_sheet_org),
                 sg.Checkbox("st_dev_", key="-BIO_PLATE_REPORT_NORM_ST_DEV_PERCENTAGE-", enable_events=True,
                             default=self.plate_setup["plate_calc_dict"]["original"]["st_dev_%"])],
                ...
                [sg.Checkbox("Pora", key="-BIO_PLATE_REPORT_PORA_CAL-", enable_events=True,
                 ...
                 sg.Checkbox("stdev", key="-BIO_PLATE_CAL_PORA_STDEV-",
                             ...
                             disabled=analysis_sheet_pora)],
                [sg.Checkbox("pstdev", key="-BIO_PLATE_REPORT_PORA_PST_DEV-", enable_events=True,
                             default=self.plate_setup["plate_calc_dict"]["original"]["pstdev"]),
                 sg.Checkbox("pvariance", key="-BIO_PLATE_CAL_PORA_P_VARIANCE-",
                             default=self.plate_setup["plate_calc_dict"]["original"]["pvariance"],
                             disabled=analysis_sheet_org),
                 sg.Checkbox("variance", key="-BIO_PLATE_CAL_PORA_VARIANCE-",
                             default=self.plate_setup["plate_calc_dict"]["original"]["variance"],
                             disabled=analysis_sheet_org),
                 sg.Checkbox("st_dev_", key="-BIO_PLATE_REPORT_PORA_ST_DEV_PERCENTAGE-", enable_events=True,
                             default=self.plate_setup["plate_calc_dict"]["original"]["st_dev_%"])],
        ...
        col_report_sheet = sg.Frame("Setup for report sheet", [[
            sg.Column([
                ...
                [sg.Checkbox("pstdev", key="-BIO_REPORT_CAL_ORG_PST_DEV-", enable_events=True,
                             default=self.plate_setup["plate_calc_dict"]["original"]["pstdev"]),
                 sg.Checkbox("pvariance", key="-BIO_REPORT_CAL_ORG_P_VARIANCE-",
                             default=self.plate_setup["plate_calc_dict"]["original"]["pvariance"],
                             disabled=analysis_sheet_org),
                 sg.Checkbox("variance", key="-BIO_REPORT_CAL_ORG_VARIANCE-",
                             default=self.plate_setup["plate_calc_dict"]["original"]["variance"],
                             disabled=analysis_sheet_org),
                 sg.Checkbox("st_dev_", key="-BIO_REPORT_CAL_ORG_ST_DEV_PERCENTAGE-", enable_events=True,
                             default=self.plate_setup["plate_calc_dict"]["original"]["st_dev_%"])],
                ...
                [sg.Checkbox("pstdev", key="-BIO_REPORT_CAL_NORM_PST_DEV-", enable_events=True,
                             default=self.plate_setup["plate_calc_dict"]["original"]["pstdev"]),
                 sg.Checkbox("pvariance", key="-BIO_REPORT_CAL_NORM_P_VARIANCE-",
                             default=self.plate_setup["plate_calc_dict"]["original"]["pvariance"],
                             disabled=analysis_sheet_org),
                 sg.Checkbox("variance", key="-BIO_REPORT_CAL_NORM_VARIANCE-",
                             default=self.plate_setup["plate_calc_dict"]["original"]["variance"],
                             disabled=analysis_sheet_org),
                 sg.Checkbox("st_dev_", key="-BIO_REPORT_CAL_NORM_ST_DEV_PERCENTAGE-", enable_events=True,
                             default=self.plate_setup["plate_calc_dict"]["original"]["st_dev_%"])],
                [sg.Checkbox("Sample", key="-BIO_REPORT_CAL_NORM_SAMPLE-", disabled=report_sheet_norm,
                ...
                [sg.Checkbox("pstdev", key="-BIO_REPORT_CAL_PORA_PST_DEV-", enable_events=True,
                             default=self.plate_setup["plate_calc_dict"]["original"]["pstdev"]),
                 sg.Checkbox("pvariance", key="-BIO_REPORT_CAL_PORA_P_VARIANCE-",
                             default=self.plate_setup["plate_calc_dict"]["original"]["pvariance"],
                             disabled=analysis_sheet_org),
                 sg.Checkbox("variance", key="-BIO_REPORT_CAL_PORA_VARIANCE-",
                             default=self.plate_setup["plate_calc_dict"]["original"]["variance"],
                             disabled=analysis_sheet_org),
                 sg.Checkbox("st_dev_", key="-BIO_REPORT_CAL_PORA_ST_DEV_PERCENTAGE-", enable_events=True,
                             default=self.plate_setup["plate_calc_dict"]["original"]["st_dev_%"])],
                [sg.Checkbox("Sample", key="-BIO_REPORT_CAL_PORA_SAMPLE-", disabled=report_sheet_pora,
    ...
    def bio_method_single_point(self):
        ...
        single_point = sg.Frame("Single point report setup", [[
            sg.Column([
                ...
                [sg.Text("Hit Threshold", relief="groove", size=10), sg.T("Minimum", size=7), sg.T("Maximum", size=8)],
                [sg.T("TH-1 bound", size=10),
                 sg.Checkbox("use", key="-PLATE_PORA_TH_1_USE-", size=self.checkbox_size,
                             default=self.plate_setup["pora_threshold"]["th_1"]["use"]),
                 sg.InputText(key="-PLATE_PORA_TH_1_MIN_HIT_THRESHOLD-", size=input_text_size,
                              default_text=self.plate_setup["pora_threshold"]["th_1"]["min"]),
                 sg.InputText(key="-PLATE_PORA_TH_1_MAX_HIT_THRESHOLD-", size=input_text_size,
                              default_text=self.plate_setup["pora_threshold"]["th_1"]["max"])],
                [sg.T("TH-2 bound", size=10),
                 sg.Checkbox("use", key="-PLATE_PORA_TH_2_USE-", size=self.checkbox_size,
                             default=self.plate_setup["pora_threshold"]["th_2"]["use"]),
                 sg.InputText(key="-PLATE_PORA_TH_2_MIN_HIT_THRESHOLD-", size=input_text_size,
                              default_text=self.plate_setup["pora_threshold"]["th_2"]["min"]),
                 sg.InputText(key="-PLATE_PORA_TH_2_MAX_HIT_THRESHOLD-", size=input_text_size,
                              default_text=self.plate_setup["pora_threshold"]["th_2"]["max"])],
                [sg.T("TH-3 bound", size=10),
                 sg.Checkbox("use", key="-PLATE_PORA_TH_3_USE-", size=self.checkbox_size,
                             default=self.plate_setup["pora_threshold"]["th_3"]["use"]),
                 sg.InputText(key="-PLATE_PORA_TH_3_MIN_HIT_THRESHOLD-", size=input_text_size,
                              default_text=self.plate_setup["pora_threshold"]["th_3"]["min"]),
                 sg.InputText(key="-PLATE_PORA_TH_3_MAX_HIT_THRESHOLD-", size=input_text_size,
                              default_text=self.plate_setup["pora_threshold"]["th_3"]["max"])],
                [sg.T("TH-4 bound", size=10),
                 sg.Checkbox("use", key="-PLATE_PORA_TH_4_USE-", size=self.checkbox_size,
                             default=self.plate_setup["pora_threshold"]["th_4"]["use"]),
                 sg.InputText(key="-PLATE_PORA_TH_4_MIN_HIT_THRESHOLD-", size=input_text_size,
                              default_text=self.plate_setup["pora_threshold"]["th_4"]["min"]),
                 sg.InputText(key="-PLATE_PORA_TH_4_MAX_HIT_THRESHOLD-", size=input_text_size,
                              default_text=self.plate_setup["pora_threshold"]["th_4"]["max"])],
                [sg.T("TH-5 bound", size=10),
                 sg.Checkbox("use", key="-PLATE_PORA_TH_5_USE-", size=self.checkbox_size,
                             default=self.plate_setup["pora_threshold"]["th_5"]["use"]),
                 sg.InputText(key="-PLATE_PORA_TH_5_MIN_HIT_THRESHOLD-", size=input_text_size,
                              default_text=self.plate_setup["pora_threshold"]["th_5"]["min"]),
                 sg.InputText(key="-PLATE_PORA_TH_5_MAX_HIT_THRESHOLD-", size=input_text_size,
                              default_text=self.plate_setup["pora_threshold"]["th_5"]["max"])],
                [sg.T("TH-6 bound", size=10),
                 sg.Checkbox("use", key="-PLATE_PORA_TH_6_USE-", size=self.checkbox_size,
                             default=self.plate_setup["pora_threshold"]["th_6"]["use"]),
                 sg.InputText(key="-PLATE_PORA_TH_6_MIN_HIT_THRESHOLD-", size=input_text_size,
                              default_text=self.plate_setup["pora_threshold"]["th_6"]["min"]),
                 sg.InputText(key="-PLATE_PORA_TH_6_MAX_HIT_THRESHOLD-", size=input_text_size,
                              default_text=self.plate_setup["pora_threshold"]["th_6"]["max"])],
                [sg.T("TH-7 bound", size=10),
                 sg.Checkbox("use", key="-PLATE_PORA_TH_7_USE-", size=self.checkbox_size,
                             default=self.plate_setup["pora_threshold"]["th_7"]["use"]),
                 sg.InputText(key="-PLATE_PORA_TH_7_MIN_HIT_THRESHOLD-", size=input_text_size,
                              default_text=self.plate_setup["pora_threshold"]["th_7"]["min"]),
                 sg.InputText(key="-PLATE_PORA_TH_7_MAX_HIT_THRESHOLD-", size=input_text_size,
                              default_text=self.plate_setup["pora_threshold"]["th_7"]["max"])],
                [sg.T("TH-8 bound", size=10),
                 sg.Checkbox("use", key="-PLATE_PORA_TH_8_USE-", size=self.checkbox_size,
                             default=self.plate_setup["pora_threshold"]["th_8"]["use"]),
                 sg.InputText(key="-PLATE_PORA_TH_8_MIN_HIT_THRESHOLD-", size=input_text_size,
                              default_text=self.plate_setup["pora_threshold"]["th_8"]["min"]),
                 sg.InputText(key="-PLATE_PORA_TH_8_MAX_HIT_THRESHOLD-", size=input_text_size,
                              default_text=self.plate_setup["pora_threshold"]["th_8"]["max"])],
                [sg.T("TH-9 bound", size=10),
                 sg.Checkbox("use", key="-PLATE_PORA_TH_9_USE-", size=self.checkbox_size,
                             default=self.plate_setup["pora_threshold"]["th_9"]["use"]),
                 sg.InputText(key="-PLATE_PORA_TH_9_MIN_HIT_THRESHOLD-", size=input_text_size,
                              default_text=self.plate_setup["pora_threshold"]["th_9"]["min"]),
                 sg.InputText(key="-PLATE_PORA_TH_9_MAX_HIT_THRESHOLD-", size=input_text_size,
                              default_text=self.plate_setup["pora_threshold"]["th_9"]["max"])],
                [sg.T("TH-10 bound", size=10),
                 sg.Checkbox("use", key="-PLATE_PORA_TH_10_USE-", size=self.checkbox_size,
                             default=self.plate_setup["pora_threshold"]["th_10"]["use"]),
                 sg.InputText(key="-PLATE_PORA_TH_10_MIN_HIT_THRESHOLD-", size=input_text_size,
                              default_text=self.plate_setup["pora_threshold"]["th_10"]["min"]),
                 sg.InputText(key="-PLATE_PORA_TH_10_MAX_HIT_THRESHOLD-", size=input_text_size,
                              default_text=self.plate_setup["pora_threshold"]["th_10"]["max"])],
                [sg.HorizontalSeparator()],
                [sg.T("Hit map colours", relief="groove")],
                [sg.ColorChooserButton("TH-1 Colour", key="-PLATE_REPORT_HIT_TH_1_COLOUR-", size=(15, None),
                                       target="-PLATE_REPORT_HIT_TH_1_COLOUR_TARGET-",
                                       button_color=self.config["Settings_bio"]
                                       ["plate_report_pora_threshold_colour_th_1"]),
                 sg.Input(key="-PLATE_REPORT_HIT_TH_1_COLOUR_TARGET-", visible=False, enable_events=True, disabled=True,
                          default_text=self.config["Settings_bio"]["plate_report_pora_threshold_colour_th_1"]),

                 sg.ColorChooserButton("TH-2 Colour", key="-PLATE_REPORT_HIT_TH_2_COLOUR-", size=(15, None),
                                       target="-PLATE_REPORT_HIT_TH_2_COLOUR_TARGET-",
                                       button_color=self.config["Settings_bio"]
                                       ["plate_report_pora_threshold_colour_th_2"]),
                 sg.Input(key="-PLATE_REPORT_HIT_TH_2_COLOUR_TARGET-", visible=False, enable_events=True, disabled=True,
                          default_text=self.config["Settings_bio"]["plate_report_pora_threshold_colour_th_2"]),

                 sg.ColorChooserButton("TH-3 Colour", key="-PLATE_REPORT_HIT_TH_3_COLOUR-", size=(15, None),
                                       target="-PLATE_REPORT_HIT_TH_3_COLOUR_TARGET-",
                                       button_color=self.config["Settings_bio"]
                                       ["plate_report_pora_threshold_colour_th_3"]),
                 sg.Input(key="-PLATE_REPORT_HIT_TH_3_COLOUR_TARGET-", visible=False, enable_events=True, disabled=True,
                          default_text=self.config["Settings_bio"]["plate_report_pora_threshold_colour_th_3"])],

                [sg.ColorChooserButton("TH-4 Colour", key="-PLATE_REPORT_HIT_TH_4_COLOUR-", size=(15, None),
                                       target="-PLATE_REPORT_HIT_TH_4_COLOUR_TARGET-",
                                       button_color=self.config["Settings_bio"]
                                       ["plate_report_pora_threshold_colour_th_4"]),
                 sg.Input(key="-PLATE_REPORT_HIT_TH_4_COLOUR_TARGET-", visible=False, enable_events=True, disabled=True,
                          default_text=self.config["Settings_bio"]["plate_report_pora_threshold_colour_th_4"]),

                 sg.ColorChooserButton("TH-5 Colour", key="-PLATE_REPORT_HIT_TH_5_COLOUR-", size=(15, None),
                                       target="-PLATE_REPORT_HIT_TH_5_COLOUR_TARGET-",
                                       button_color=self.config["Settings_bio"]
                                       ["plate_report_pora_threshold_colour_th_5"]),
                 sg.Input(key="-PLATE_REPORT_HIT_TH_5_COLOUR_TARGET-", visible=False, enable_events=True, disabled=True,
                          default_text=self.config["Settings_bio"]["plate_report_pora_threshold_colour_th_5"]),

                 sg.ColorChooserButton("TH-6 Colour", key="-PLATE_REPORT_HIT_TH_6_COLOUR-", size=(15, None),
                                       target="-PLATE_REPORT_HIT_TH_6_COLOUR_TARGET-",
                                       button_color=self.config["Settings_bio"]
                                       ["plate_report_pora_threshold_colour_th_6"]),
                 sg.Input(key="-PLATE_REPORT_HIT_TH_6_COLOUR_TARGET-", visible=False, enable_events=True, disabled=True,
                          default_text=self.config["Settings_bio"]["plate_report_pora_threshold_colour_th_6"])],

                [sg.ColorChooserButton("TH-7 Colour", key="-PLATE_REPORT_HIT_TH_7_COLOUR-", size=(15, None),
                                       target="-PLATE_REPORT_HIT_TH_7_COLOUR_TARGET-",
                                       button_color=self.config["Settings_bio"]
                                       ["plate_report_pora_threshold_colour_th_7"]),
                 sg.Input(key="-PLATE_REPORT_HIT_TH_7_COLOUR_TARGET-", visible=False, enable_events=True, disabled=True,
                          default_text=self.config["Settings_bio"]["plate_report_pora_threshold_colour_th_7"]),

                 sg.ColorChooserButton("TH-8 Colour", key="-PLATE_REPORT_HIT_TH_8_COLOUR-", size=(15, None),
                                       target="-PLATE_REPORT_HIT_TH_8_COLOUR_TARGET-",
                                       button_color=self.config["Settings_bio"]
                                       ["plate_report_pora_threshold_colour_th_8"]),
                 sg.Input(key="-PLATE_REPORT_HIT_TH_8_COLOUR_TARGET-", visible=False, enable_events=True, disabled=True,
                          default_text=self.config["Settings_bio"]["plate_report_pora_threshold_colour_th_8"]),

                 sg.ColorChooserButton("TH-9 Colour", key="-PLATE_REPORT_HIT_TH_9_COLOUR-", size=(15, None),
                                       target="-PLATE_REPORT_HIT_TH_9_COLOUR_TARGET-",
                                       button_color=self.config["Settings_bio"]
                                       ["plate_report_pora_threshold_colour_th_9"]),
                 sg.Input(key="-PLATE_REPORT_HIT_TH_9_COLOUR_TARGET-", visible=False, enable_events=True, disabled=True,
                          default_text=self.config["Settings_bio"]["plate_report_pora_threshold_colour_th_9"])],

                [sg.ColorChooserButton("TH-10 Colour", key="-PLATE_REPORT_HIT_TH_10_COLOUR-", size=(15, None),
                                       target="-PLATE_REPORT_HIT_TH_10_COLOUR_TARGET-",
                                       button_color=self.config["Settings_bio"]
                                       ["plate_report_pora_threshold_colour_th_10"]),
                 sg.Input(key="-PLATE_REPORT_HIT_TH_10_COLOUR_TARGET-", visible=False, enable_events=True, disabled=True,
